...
if(isset($_POST["submit"]))
{
	...
	$admin = $con->query("select * from deliveryman where deliveryman_id='$id' && password='$oldpassword'");
	...
	if($rowcount==1)
	{
		...
		{
			$con->query("update deliveryman set password='$newpassword' where deliveryman_id='$id'");
						...
						<div class="form-three widget-shadow">
							...
							<form class="form-horizontal" method="post">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="password" class="form-control1" minlength="8" id="oldpassword" name="oldpassword" placeholder="Enter old password" required>
										<?php 
											if(isset($_POST["submit"])){
												if($rowcount != 1){
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="password" class="form-control1" minlength="8" id="newpassword" name="newpassword" placeholder="Enter New Password" required>
									</div>
								</div>
								<div class="form-group">
									<label for="cnewpassword" class="col-sm-2 control-label">Confirm New Password</label>
									<div class="col-sm-8">
										<input type="password" class="form-control1" minlength="8" id="cnewpassword" name="cnewpassword" placeholder="Enter New Password" required>
										<?php 
											if(isset($_POST['submit'])){
												if($newpassword != $cnewpassword){
