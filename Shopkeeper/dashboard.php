...
$shop = $con->query("select * from shop where shop_id='$user_id' ");
$feedback = $con->query("select * from feedback where shop_id='$user_id' ");
$del = $con->query("select * from deliveryman where shop_id='$user_id' ");
